...
def imputation(vae, data_loader, rate=0.1):
    ...
    for tensorlist in data_loader:
        ...
        sample_batch, sample_qc, local_l_mean, local_l_var, batch_index, labels = tensorlist
        ...
        px_rate = vae.get_sample_rate(dropout_batch, y=labels, qc=sample_qc, batch_index=batch_index)
