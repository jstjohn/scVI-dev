...
class VAECQC(nn.Module):
    ...
    def forward(self, x, local_l_mean, local_l_var, qc, batch_index=None, y=None, eps=1e-8):  # same signature as loss
        ...
        if not is_labelled:
            ...
            qz_m = qz_m.repeat(self.n_labels, 1)
            qz_v = qz_v.repeat(self.n_labels, 1)
        ...
        if self.dispersion == "gene-cell":
            ...
            px_scale, px_rate, px_dropout, ps_logit = self.decoder(self.dispersion, z, u, library, batch_index, y=y_)
